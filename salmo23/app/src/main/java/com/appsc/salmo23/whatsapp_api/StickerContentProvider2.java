...
public class StickerContentProvider2 extends ContentProvider {
    ...
    public static Uri AUTHORITY_URI = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT).authority(BuildConfig.CONTENT_PROVIDER_AUTHORITY2).appendPath(StickerContentProvider2.METADATA).build();
    ...
    private String link     = "nao";
    private String nome     = "nome";
    private String pacote   = "pacote";
    ...
    public boolean onCreate() {
        ...
        // Inicializa a RequestQueue aqui
        requestQueue = Volley.newRequestQueue(getContext());

        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                String apiUrl = "https://softcroy.com/app_santos_v2/api3/config/app_link_figurinhas.php?app=" + getContext().getPackageName();
                            ...
                            public void onResponse(JSONArray response) {
                                try {
                                    for (int i = 0; i < response.length(); i++) {
                                        ...
                                        pacote = jsonObject.getString("pacote");
                                    }
